...
"Agnevicthys gretchinae and Palaeopholis laevis (family
...
# Read in astral output NS tree
astral_tree <- read.tree("Trees/Astral/ASTRAL_out_NS.tree")
...
ggtree(astral_tree, layout = "slanted") +
  geom_tiplab() + 
  geom_nodelab(vjust = -.75, hjust = 1.5, color = "red") +
  geom_treescale(width = 1, offset = -.5) +
  xlim(0, 12) +
  labs(title = "Rooted astral multigene coalescence tree NS version")
